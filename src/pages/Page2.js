...
class intPage2 extends React.Component{
         
    state = {
      data: this.props.dataPage2,
      ...
      render(){  
        ...
        return  (
            ...
            <div className='header__page'>3</div>
                    ...
                    <NavLink to={this.props.startBasket.numberProducts?"/basket":"/pizzas/2 "}>
      ...
      const Page2 = connect (mapStateToProps)(intPage2);
